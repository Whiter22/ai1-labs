const WeatherApp = class {
    ...
    drawWeather() {
        ...
        if (this.forecast && this.forecast.length > 1) {
...
document.weatherApp = new WeatherApp("1ae2e48a0770066c42717998f06d6783", "#weather-results-container");

document.querySelector("#currWeather").addEventListener("click", function() {
    const query = document.querySelector("#locationInput").value;
    document.weatherApp.getCurrentWeather(query);
});


document.querySelector("#forecastWeather").addEventListener("click", function() {
    const query = document.querySelector("#locationInput").value;
